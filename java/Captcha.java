...
/**
 * This is a simple captcha class, use it to generate a random string and then
...
public class Captcha {
	...
	public static byte[] generateImage(String text) {
		...
		for (int i = 0; i < bytes.length; i++) {
			...
			g.drawString(new String(new byte[] { bytes[i] }), start + (i * 30), (int) (Math.random() * 20 + 20));
		}
